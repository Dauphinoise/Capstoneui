  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="w-full max-w-xl">
        ...
        {/* Login Card */}
        <div className="bg-white rounded-2xl shadow-xl border-2 border-yellow-200 p-10">
          {/* Header */}
          <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm font-bold text-blue-900">Enhanced Security</p>
            </div>
            <p className="text-xs text-blue-800">2-Factor Authentication required for all admin accounts</p>
          </div>
